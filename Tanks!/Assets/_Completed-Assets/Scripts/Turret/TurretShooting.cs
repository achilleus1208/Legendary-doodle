...
namespace Complete
{
    ...
    {
        public int m_TurretNumber = 1;              // Used to identify the different players.
        public Rigidbody m_Shell;                   // Prefab of the shell.
        public Transform m_FireTransform_1;           // A child of the tank where the shells are spawned.
        ...
        private void Start ()
        {
            ...
            InvokeRepeating("Fire", 0, 0.2f); // 2초뒤 0.3초주기로 LaunchProjectile함수 반복 호출
        }
